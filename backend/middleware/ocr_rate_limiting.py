...
class OCRRateLimitMiddleware(BaseHTTPMiddleware):
    ...
    def _check_rate_limit(self, client_ip: str, endpoint: str, current_time: float) -> Optional[JSONResponse]:
    ...
    def _handle_rate_limit_violation(self, client_ip: str, client_data: ClientOCRData, 
                                   config: OCRRateLimitConfig, current_time: float):
    ...
    def _validate_image_content(self, image_content: bytes, config: OCRRateLimitConfig) -> Optional[JSONResponse]:
