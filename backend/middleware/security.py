    ...
    try:
        ...
        if not user.is_active:
            ...
            raise HTTPException(
                ...
                detail={"error": "Account is inactive", "error_code": "ACCOUNT_INACTIVE"},
        ...
        raise HTTPException(
            ...
            detail={"error": "Authentication service error", "error_code": "SERVICE_ERROR"},
            headers={"WWW-Authenticate": "Bearer"}
        )
...
async def require_verified_user(
    ...
    if not current_user.is_verified:
        ...
        raise HTTPException(
            ...
            detail={"error": "Email verification required", "error_code": "EMAIL_NOT_VERIFIED"}
        )
...
async def admin_required(
    ...
    if not current_user.is_super_admin:
        ...
        raise HTTPException(
            status_code=status.HTTP_403_FORBIDDEN,
            detail={"error": "Admin privileges required", "error_code": "INSUFFICIENT_PRIVILEGES"}
        )
