...
class JsonFormatter(logging.Formatter):
    ...
    def format(self, record: logging.LogRecord) -> str:
        ...
        if record.exc_info and self.include_stack_info:
            ...
            formatted_exception = traceback.format_exception(exception_type, exception_value, exception_tb)
            log_data["exception"] = {
...
class StructuredLogger:
    ...
    def trace(self, msg: str, context: Optional[Dict[str, Any]] = None, 
    ...
    def error(self, msg: str, context: Optional[Dict[str, Any]] = None, 
              data: Optional[Dict[str, Any]] = None, exc_info: Any = None) -> None:
        """
    ...
    def exception(self, msg: str, context: Optional[Dict[str, Any]] = None, 
                  data: Optional[Dict[str, Any]] = None) -> None:
        """
