...
class IngredientNamesManager:
    ...
    def _get_metadata(self) -> Dict:
        ...
        return {"last_updated": None, "ingredient_count": 0, "version": 1}
    ...
    async def load_ingredients_from_database(self) -> List[str]:
        ...
        try:
            ...
            logger.info(
                f"Successfully loaded {len(all_ingredients)} ingredient names from database"
            )
    ...
    def save_ingredients_to_file(self, ingredient_names: List[str]) -> bool:
        ...
        try:
            ...
            logger.info(
                f"Successfully saved {len(ingredient_names)} ingredients to {self.file_path}"
            )
            return True
