...
OCR_ERROR_PATTERNS = {
    'unit_errors': {
        'its': 'lbs', 'ibs': 'lbs', 'ib': 'lb', '1b': 'lb', '11b': 'lbs',
        'bs': 'lbs', 'ts': 'lbs', 'goz': 'oz', '02': 'oz', '0z': 'oz',
        'galon': 'gallon', 'gailon': 'gallon', 'galion': 'gallon',
        'cound': 'count', 'couns': 'count', 'counl': 'count',
        'bults': 'bulbs', 'butte': 'bulbs', 'bulhs': 'bulbs',
        'tresh': 'fresh', 'frfsh': 'fresh', 'frcsh': 'fresh'
    },
    'product_errors': {
        'Tomatnes': 'Tomatoes', 'Onins': 'Onions', 'Garlie': 'Garlic',
        'Mitk': 'Milk', 'Imtik': 'Milk', 'Fggs': 'Eggs', 'Chesidar': 'Cheddar',
        'Pasa': 'Pasta', 'Otiweoit': 'Olive Oil', 'Basilfresh': 'Basil Fresh'
    }
}
...
class TestDataGenerator:
    ...
    def generate_ocr_processed_response(
        ...
        for i in range(items_count):
            items.append(TestDataGenerator.generate_receipt_item(
                text=f"Test Item {i+1}",
                suggestions_count=random.randint(1, 3)
            ))
    ...
    def generate_mock_ingredient_search_results(
        ...
        for i in range(count):
            ingredients.append(TestDataGenerator.generate_mock_ingredient(
