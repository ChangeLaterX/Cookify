...
class AuthTestConfig:
    ...
    # Dependencies
    SUPABASE_AVAILABLE: bool = os.getenv('SUPABASE_URL') is not None and os.getenv('SUPABASE_ANON_KEY') is not None
...
class AuthTestUtils:
    ...
    @staticmethod
    def create_mock_supabase_response(success: bool = True, user_data: Optional[Dict] = None) -> Dict[str, Any]:
