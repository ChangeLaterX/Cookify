...
def show_all_endpoint_configurations():
    ...
    health_endpoints = [
        ...
        (settings.HEALTH_SERVICE_HISTORY_ENDPOINT, settings.HEALTH_SERVICE_HISTORY_TITLE),
    ]
    
    for endpoint, title in health_endpoints:
        full_path = settings.HEALTH_PREFIX + endpoint if endpoint != '/' else settings.HEALTH_PREFIX + endpoint
    ...
    ingredients_endpoints = [
        (settings.INGREDIENTS_MASTER_ENDPOINT, "GET", settings.INGREDIENTS_MASTER_LIST_TITLE),
        (settings.INGREDIENTS_MASTER_BY_ID_ENDPOINT, "GET", settings.INGREDIENTS_MASTER_GET_TITLE),
        (settings.INGREDIENTS_MASTER_ENDPOINT, "POST", settings.INGREDIENTS_MASTER_CREATE_TITLE),
        (settings.INGREDIENTS_MASTER_BY_ID_ENDPOINT, "PUT", settings.INGREDIENTS_MASTER_UPDATE_TITLE),
        (settings.INGREDIENTS_MASTER_BY_ID_ENDPOINT, "DELETE", settings.INGREDIENTS_MASTER_DELETE_TITLE),
        (settings.INGREDIENTS_SEARCH_ENDPOINT, "GET", settings.INGREDIENTS_SEARCH_TITLE),
        (settings.INGREDIENTS_PANTRY_ENDPOINT, "GET", settings.INGREDIENTS_PANTRY_LIST_TITLE),
        (settings.INGREDIENTS_PANTRY_ENDPOINT, "POST", settings.INGREDIENTS_PANTRY_CREATE_TITLE),
        (settings.INGREDIENTS_PANTRY_BY_ID_ENDPOINT, "PUT", settings.INGREDIENTS_PANTRY_UPDATE_TITLE),
        (settings.INGREDIENTS_PANTRY_BY_ID_ENDPOINT, "DELETE", settings.INGREDIENTS_PANTRY_DELETE_TITLE),
        (settings.INGREDIENTS_SHOPPING_LIST_ENDPOINT, "GET", settings.INGREDIENTS_SHOPPING_LIST_TITLE),
        (settings.INGREDIENTS_SHOPPING_LIST_ENDPOINT, "POST", settings.INGREDIENTS_SHOPPING_ADD_TITLE),
        (settings.INGREDIENTS_SHOPPING_LIST_BY_ID_ENDPOINT, "PUT", settings.INGREDIENTS_SHOPPING_UPDATE_TITLE),
        (settings.INGREDIENTS_SHOPPING_LIST_BY_ID_ENDPOINT, "DELETE", settings.INGREDIENTS_SHOPPING_DELETE_TITLE),
        (settings.INGREDIENTS_CACHE_UPDATE_ENDPOINT, "POST", settings.INGREDIENTS_CACHE_UPDATE_TITLE),
    ]
    ...
    ocr_endpoints = [
        ...
        (settings.OCR_PROCESS_RECEIPT_ENDPOINT, "POST", settings.OCR_PROCESS_RECEIPT_TITLE),
    ...
    auth_endpoints = [
        ...
        (settings.AUTH_RESET_PASSWORD_ENDPOINT, "POST", settings.AUTH_RESET_PASSWORD_TITLE),
    ...
    print()
    update_endpoints = [
        (settings.UPDATE_INGREDIENT_CACHE_ENDPOINT, "POST", settings.UPDATE_INGREDIENT_CACHE_TITLE),
        (settings.UPDATE_INGREDIENT_CACHE_STATUS_ENDPOINT, "GET", settings.UPDATE_INGREDIENT_CACHE_STATUS_TITLE),
